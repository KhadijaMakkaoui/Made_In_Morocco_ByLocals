                ...
                <div class="col-md-12 col-lg-12">
                    <div class="wrap d-md-flex justify-content-center align-items-center">
                                ...
                                <div class="mask-c">
                                    <div class="d-flex justify-content-center align-items-center h-100">
                                        <div class="text-white text-center">
                                            ...
                                            <p> Inscrivez-vous afin de consulter librement nos produits</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="p-2  bg-white shadow">
                            ...
                            <div action="#" class="signin-form justify-content-center align-items-center">
                                <div class="mb-2 mx-3">
                                ...
                                <div class="text-center my-1">
                                    <p class=" mb-0">êtes vous fabriquant?
                                        <a href="/registerVendeur" class="text-secondary ">Inscrivez-vous ici</a>
                                    </p>
